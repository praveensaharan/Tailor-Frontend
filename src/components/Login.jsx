...
const Login = ({ authenticateUser }) => {
  ...
  const handleSubmit = (event) => {
    ...
    // Call the authenticateUser function with the entered email and password
    const isAuthenticated = authenticateUser(email, password);
    if (isAuthenticated) {
      // If authentication is successful, set the logged-in state to true and redirect to the dashboard
      navigate("/dashboard");
    } else {
