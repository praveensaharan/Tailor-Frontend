...
// const OrdersPage = () => {
//   return (
//     <div className="bg-gray-100 min-h-screen py-6 mt-24">
//       <div className="max-w-3xl mx-auto bg-red-200 rounded-lg shadow-md p-6 m-5">
//         <h2 className="text-2xl font-semibold mb-6">Orders</h2>
//         <ul className="border-5 p-4">
//           {ordersData.map((order) => (
//             <li
//               key={order.orderid}
//               className="py-4 flex justify-between m-3 bg-slate-300 p-8 border-black border-4 rounded-xl"
//             >
//               <div>
//                 <p>
