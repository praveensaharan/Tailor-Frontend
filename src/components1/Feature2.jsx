const Index = () => (
  <div classname="overflow-y-hidden bg-gray-100 dark:bg-slate-500">
    <div className="mx-auto container f-f-p px-4 xl:px-0 py-24 dark:bg-slate-300">
        ...
        <div className="hidden md:flex justify-center w-full">
          <div className="flex flex-col items-center md:items-end md:pr-12 md:border-r-4 border-gray-300 relative md:w-1/2">
            ...
            <div className="flex mt-12 flex-col items-center lg:items-end md:w-8/12">
              <h1 className="focus:outline-none text-xl font-bold leading-5">
                Connect with Your Chosen Tailor
              </h1>
              <h2 className="focus:outline-none text-gray-500 mt-3 pl-3 text-center md:text-right text-base leading-6 tracking-wide">
                Communicate directly with your selected tailor, discussing
                design ideas, fabric choices, and style preferences.{" "}
              </h2>
            </div>
          ...
          <div className="flex flex-col items-center md:items-start md:pl-12 lg:border-gray-400 mt-20 md:mt-0 md:w-1/2">
            ...
            <div className="flex mt-6 flex-col items-center md:items-start md:w-8/12">
              <h1 className="focus:outline-none text-xl font-bold leading-5">
                Create Your Tailor-Made Account
              </h1>
              <h2 className="focus:outline-none text-gray-500 mt-3 text-base leading-6 tracking-wide">
                Sign up on our website, choose your preferred tailor, and
                explore personalized fashion options. .{" "}
              </h2>
            </div>
            ...
            <div className="flex mt-6 flex-col items-center md:items-start md:w-8/12">
              <h1 className="focus:outline-none text-xl font-bold leading-5">
                Get Custom-Fit Clothing Delivered
              </h1>
              <h2 className="focus:outline-none text-gray-500 mt-3 text-base leading-6 tracking-wide">
                Sit back and relax as your tailor creates your one-of-a-kind
                clothing. Receive your bespoke garments, perfectly tailored to
                your measurements, delivered right to your doorstep.
              </h2>
            </div>
          </div>
        </div>
